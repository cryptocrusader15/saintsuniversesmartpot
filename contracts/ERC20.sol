 ...
 * to implement supply mechanisms]. // SPDX-License-Identifier: MIT
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        unchecked {
            _approve(owner, spender, currentAllowance - subtractedValue); "Error in decrease allowance";
        }
    ...
    function _transfer(
        ...
        _balances[sender] = _balances[sender].sub(amount, "Transfer Balance is too Low");
